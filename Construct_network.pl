...
sub construct_driver_net_network{
    my ($index_to_gene, $gene_to_index, $connections, $scripts_dir) = @_;
    #print STDERR " *** BEGIN DRIVER_NET NETWORK CONSTRUCTION\n";
    $network = "$scripts_dir/network_FIsInGene_041709.txt";
...
sub construct_netbox_network{
    my ($data_dir, $index_to_gene, $gene_to_index, $connections, $flag_update, $scripts_dir) = @_;
    $network_gene_list = "$scripts_dir/Homo_sapiens.gene_info";
    $network = "$scripts_dir/netbox.script";
